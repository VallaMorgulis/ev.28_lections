# ассоциация - принцип ООП который устанавливает два класса свзанных друг с другом. Связь обозначает то что врутри одного объекта бует существовать другоц объект от другого класса.
# агрегация - слобая связь
