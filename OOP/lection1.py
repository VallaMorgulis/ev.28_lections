...
этом как о конкретной собаке или о своей собственной собаке. Мы описываем, что собака вообще может делать. Собаки обычно имеют 
Примером класса является класс Dog. Не думайте об name и age - это атрибуты экземпляра. Собаки могут также лаять (bark) - это метод.
